...
<EndpointComponent method="GET" url="/v2/domains" />
...
<EndpointComponent method="POST" url="/v2/domains" />
...
<EndpointComponent method="POST" url="/v2/domains/:name/verify" />
...
<EndpointComponent url="/v4/domains/:name" />
...
<EndpointComponent method="DELETE" url="/v4/domains/:name" />
...
<EndpointComponent method="GET" url="/v4/domains/status?name" />
...
<EndpointComponent method="GET" url="/v4/domains/price?name" />
...
<EndpointComponent method="POST" url="/v4/domains/buy" />
