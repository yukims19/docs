...
<EndpointComponent method="GET" url="/v2/now/aliases" />
...
<EndpointComponent method="DELETE" url="/v2/now/aliases/:id" />
...
<EndpointComponent method="PURGE" url="/v2/now/aliases/:id" />
...
<EndpointComponent method="GET" url="/v2/now/deployments/:id/aliases" />
...
<EndpointComponent method="POST" url="/v2/now/deployments/:id/aliases" />
